@verbatim
    ...
    <script type="text/html" id="tpl-picture">
        {{# if(d.picture){ }}
        <img lay-event="show_img" style="" src= {{ d.picture}}>
        {{#  }; }}
    </script>
    <script type="text/html" id="tpl-security_code">
        {{# if(d.security_code){ }}
        <img lay-event="show_img" style="" src= {{ d.security_code}}>
        {{#  }; }}
    </script>
    ...
    <script>
        ...
        //回调函数
        function layui_status(field, d, text, value, true_value, false_value) {
            value = value || 1;
            text = text || '是|否';
            true_value = true_value || 1;
