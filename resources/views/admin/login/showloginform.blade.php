...
@section('add_css')
    ...
    <style type="text/css">
        html{
            background-image: url(@basic(background)) ;
        }
    </style>
    ...
    <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login">
        ...
        <div class="layadmin-user-login-main">
            <div class="layadmin-user-login-box layadmin-user-login-header">
                <h2>@basic(system_name)</h2>
                <p>@basic(system_desc)</p>
            </div>
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs5">
                            <div style="margin-left: 10px;">
                                <img src="{{ route('captcha',['type'=>3]) }}"
                                     data-src="{{ route('captcha',['type'=>3]) }}"
        ...
        <div class="layui-trans layadmin-user-login-footer">
            ...
            <p>
                © {{ date('Y') }} <a href="@basic(domain)" target="_blank">@basic(system_name)</a>
                &nbsp;
                &nbsp;
                @basic(record)
            </p>
...
@section('foot_js')
    <script>
        ...
        // layui.config({dir: '/static/layui/lay/modules/'});
